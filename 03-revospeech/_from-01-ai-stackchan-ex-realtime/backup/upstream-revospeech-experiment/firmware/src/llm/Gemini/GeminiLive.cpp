...
static const char session_update[] =
        "{"
          "\"setup\": {"
            ...
            "],"
            "\"systemInstruction\": {"
              "\"parts\": [{\"text\": \"You are an AI robot named Stack-chan. Speak in Bahasa Melayu Malaysia with a natural Malaysian Malay accent. Use Malaysian vocabulary and pronunciation, not Indonesian Malay.\"}],"
              "\"role\": \"user\""
            "}"
          "}"
        "}";
