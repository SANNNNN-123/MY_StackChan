...
root.innerHTML = `
  <header class="topbar"><div class="brand"><span>＋</span> STACKCHAN <small>OFFICIAL MODEL VIEWER</small></div><div class="status"><i></i> M5STACK ASSET / <b>GLB</b> <a class="status-link" href="/">HOME</a></div></header>
  <main class="layout">
    <aside class="left panel"><div class="eyebrow">ARCHIVE / 004</div><h1>StackChan<br><em>Official Model</em></h1><p>Complete rendered model published with M5Stack’s official StackChan application.</p><div class="rule"></div><label>SOURCE FILE</label><div class="readout"><span>ASSET<strong>stack_chan_model.glb</strong></span><span>FORMAT<strong>GLB / glTF 2.0</strong></span><span>MODE<strong>ASSEMBLED</strong></span></div><a class="source" href="/">RETURN / STL ASSEMBLY</a></aside>
