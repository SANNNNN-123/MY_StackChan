...
root.innerHTML = `
  ...
  <main class="layout">
    <aside class="left panel"><div class="eyebrow">ARCHIVE / 004</div><h1>StackChan<br><em>Official Model</em></h1><p>Complete rendered model published with M5Stack’s official StackChan application.</p><div class="rule"></div><label>SOURCE FILE</label><div class="readout"><span>ASSET<strong>stack_chan_model.glb</strong></span><span>FORMAT<strong>GLB / glTF 2.0</strong></span><span>MODE<strong>ASSEMBLED</strong></span></div><a class="source" href="/">HOME / STL ASSEMBLY ↗</a></aside>
