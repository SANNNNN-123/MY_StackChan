/*
 * joy.js - Roberto D'Amico (Bobboteck)
...
var JoyStick = (function(container, parameters, callback)
{
 ...
 var arrowLength = internalRadius/2;
 context.strokeStyle = internalStrokeColor;
 context.lineWidth = internalLineWidth;
 if(!axisOnlyY)
 {
 ...
 var arrowHeadSize = 0.2;
 context.lineCap = "round";
 var dx = toX - fromX;
 var dy = toY - fromY;
 var headLength = Math.sqrt(dx*dx + dy*dy) * arrowHeadSize;
 context.beginPath();
 ...
 if(axisOnlyY) { movedX = centerX; }
 if(axisOnlyX) { movedY = centerY; }
 ...
 if(horizontal < directionHorizontalLimitNeg) { result = result === "C" ? "W" : result + "W"; }
 if(horizontal > directionHorizontalLimitPos) { result = result === "C" ? "E" : result + "E"; }
 return result;
 }
